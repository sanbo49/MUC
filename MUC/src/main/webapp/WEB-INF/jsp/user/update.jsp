...
<div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <div class="idTabs">
      <ul class="tab">
        <li><a href="#nav_add">修改用户</a></li>
      </ul>
      <div class="items">
        <div id="nav_add">
         <sf:form action="user/update" modelAttribute="user" method="post" id="myform">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
           ...
           <sf:hidden path="id"/>
            ...
            <td>
            <sf:input path="userName" size="40"  class="inpMain validate[required]"/>
            </td>
           </tr>
           <tr>
            <td width="80" height="35" align="right">年龄</td>
            <td>
              <sf:input path="age" size="40"  class="inpMain validate[required,custom[integer],min[0]]"/>
            </td>
           </tr>
           ...
           <tr>
            ...
            <td>
             ...
             <input name="submit" class="btn" type="button" value="提交"  onclick="updateuser();" />
            </td>
           </tr>
          </table>
         </sf:form>
